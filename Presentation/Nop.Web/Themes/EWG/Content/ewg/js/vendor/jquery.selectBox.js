...
;(function ($) {
    ...
    SelectBox.prototype.generateOptions = function (self, options) {
        var li = $('<li '+($(self).data('call-popup') ? 'data-call="'+$(self).data('call-popup')+'"' : '')+'/>'), a = $('<a />');
        li.addClass(self.attr('class'));
        
        li.data(self.data());
        if (self.data('icon')) {
            a.attr('rel', self.val()).html(self.data('icon')+self.text()+'<span class="postfix">'+self.data('postfix')+'</span>');
        } else {
